...
/**
 * Interactive Glance Action Callbacks for the Home Screen Widget (spec-21 Track B / T2).
 */
        ...
        withContext(Dispatchers.Main) {
            try {
                ...
                if (playerManager.playerState.value.currentBook != null) {
                    ...
                    // Try resuming the latest book from progress
                    val latest = App.instance.repository.getLatestRecentProgress()
                    if (latest != null) {
