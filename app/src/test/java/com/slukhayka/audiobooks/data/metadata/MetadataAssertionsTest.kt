...
class MetadataAssertionsTest {
    ...
    fun `title scrub strips the real multi-word source suffixes`() {
        ...
        val cases = listOf<Pair<String, String>>(
            ...
            // audiobook-mp3.com / sound-books.net: «… - слухати онлайн аудіокнигу»
            // (infinitive + «онлайн» BEFORE the book word).
            "Клуб боягузів - слухати онлайн аудіокнигу" to "Клуб боягузів",
            "Місто - слухати онлайн аудіокнигу безкоштовно" to "Місто",
            "Кобзар — слухати онлайн аудіокнига" to "Кобзар",
            "Жага до життя | слухати онлайн аудіокниги" to "Жага до життя",
            "Кобзар - слухати аудіокнигу онлайн" to "Кобзар"
        )
        cases.forEach { (claimed, expected) ->
            assertEquals("normalizeTitle($claimed)", expected, MetadataAssertions.normalizeTitle(claimed))
        }
