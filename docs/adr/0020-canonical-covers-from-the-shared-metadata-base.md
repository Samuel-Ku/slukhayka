...
## Уточнення 2026-09-14: обкладинка вже є на сторінці каталогу

Порожні картки Audiobook-MP3 і Lihtar на скріншотах мали різні причини.
Audiobook-MP3 додавав до новинок посилання з бічного блоку коментарів:
вони не є картками каталогу й не містять обкладинок. Парсер читає лише
`article.abook-item`; відсутнього автора не підміняє назвою книги.

Lihtar вже віддає обкладинку, українську назву й автора у картці категорії.
Окремі запити сторінки кожної книги вичерпували бюджет джерела; замість
наявних метаданих з'являвся slug без зображення. Новинки та сторінка жанру
читають ці поля з самої категорії, без запиту на кожну книжку.

Старі знімки стрічок лише цих двох джерел отримують новий ключ кешу
`cards-v2`: часовий TTL не робить помилково розібрану картку придатною.
Медіатека, стан слухання, кеш решти джерел та порядок вибору канонічної
обкладинки не змінюються. Якщо джерело справді не дало зображення,
парсер лишає його відсутнім, а не вигадує адресу.
