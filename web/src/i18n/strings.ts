...
const uk = {
  ...
  libDeleteMenu: 'Видалити з Медіатеки…',
  libDeleteTitle: 'Видалити з Медіатеки?',
  libDeleteScope: 'Точна сфера: 1 книга «{title}», 1 запис медіатеки. Позицій прослуховування: {positions}. Завантажених файлів немає — видаляти з диска нічого.',
  libDeleteConfirm: 'Видалити',
...
const en: Strings = {
  ...
  libDeleteMenu: 'Remove from the Library…',
  libDeleteTitle: 'Remove from the Library?',
  libDeleteScope: 'Exact scope: 1 book «{title}», 1 library entry. Listening positions: {positions}. There are no downloaded files — nothing is removed from disk.',
  libDeleteConfirm: 'Remove',
